        ...
        >
          ...
          >
            ...
            <TouchableOpacity
              ...
              onPress={() => router.push(`/tools/pros-cons-wizard?id=${selectedAnalysis.id}&module=pros-cons`)}
              activeOpacity={0.85}
            >
              <LinearGradient
        ...
        <View style={styles.modalOverlay}>
          ...
          >
            <View style={styles.modalContent}>
              ...
              {/* Sticky footer with primary action — never hidden */}
...
const styles = StyleSheet.create({
  ...
  modalContent: {
    ...
    maxHeight: '85%',
    // overflow:hidden so the sticky footer rounds-clips correctly
    overflow: 'hidden',
  },
