...
export default function ProfileScreen() {
  ...
  const renderProfile = () => (
    <>
      ...
      <TouchableOpacity
        style={{ flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: COLORS.white, padding: 14, borderRadius: 12, borderWidth: 1, borderColor: COLORS.border, marginBottom: 12 }}
        onPress={() => router.push('/admin/review-net' as any)}
      >
        <View style={{ width: 36, height: 36, borderRadius: 18, backgroundColor: '#7C3AED', alignItems: 'center', justifyContent: 'center' }}>
          <Ionicons name="star-half" size={18} color="#FFF" />
        </View>
        <View style={{ flex: 1 }}>
          <Text style={{ fontSize: 14, fontWeight: '600', color: COLORS.textPrimary }}>ReviewNet · Moderation</Text>
          <Text style={{ fontSize: 12, color: COLORS.textMuted }}>Approve reviews + auto-publish rules</Text>
        </View>
        <Ionicons name="chevron-forward" size={18} color={COLORS.textMuted} />
      </TouchableOpacity>
      ...
      <TouchableOpacity
        style={{ flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: COLORS.white, padding: 14, borderRadius: 12, borderWidth: 1, borderColor: COLORS.border, marginBottom: 12 }}
        onPress={() => router.push('/tools/expert-net' as any)}
      >
        <View style={{ width: 36, height: 36, borderRadius: 18, backgroundColor: '#0E7490', alignItems: 'center', justifyContent: 'center' }}>
          <Ionicons name="person" size={18} color="#FFF" />
        </View>
        <View style={{ flex: 1 }}>
          <Text style={{ fontSize: 14, fontWeight: '600', color: COLORS.textPrimary }}>ExpertNet</Text>
          <Text style={{ fontSize: 12, color: COLORS.textMuted }}>Discover experts · book / connect · webinars</Text>
        </View>
        <Ionicons name="chevron-forward" size={18} color={COLORS.textMuted} />
      </TouchableOpacity>
      ...
      <TouchableOpacity
        style={{ flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: COLORS.white, padding: 14, borderRadius: 12, borderWidth: 1, borderColor: COLORS.border, marginBottom: 12 }}
        onPress={() => router.push('/tools/meditation-settings' as any)}
      >
        <View style={{ width: 36, height: 36, borderRadius: 18, backgroundColor: '#7C3AED', alignItems: 'center', justifyContent: 'center' }}>
          <Ionicons name="musical-notes" size={18} color="#FFF" />
        </View>
        <View style={{ flex: 1 }}>
          <Text style={{ fontSize: 14, fontWeight: '600', color: COLORS.textPrimary }}>Meditation Settings</Text>
          <Text style={{ fontSize: 12, color: COLORS.textMuted }}>Customize Guru Invocation, Stillness & Manifestation meditations</Text>
        </View>
        <Ionicons name="chevron-forward" size={18} color={COLORS.textMuted} />
      </TouchableOpacity>
