...
@pytest.mark.asyncio
async def test_verify_find_templates_access_on_demand_user():
...
@pytest.mark.asyncio
async def test_verify_find_templates_access_basic_user():
...
@pytest.mark.asyncio
async def test_verify_find_templates_access_pro_user():
