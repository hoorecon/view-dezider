...
from routes.catalog_payout import router as catalog_payout_router
from routes.option_publish import router as option_publish_router
...
api_router.include_router(catalog_payout_router)
api_router.include_router(option_publish_router)
...
from routes.values_routes import router as values_router  # noqa: E402
api_router.include_router(values_router)

from routes.seven_seven import router as seven_seven_router  # noqa: E402
api_router.include_router(seven_seven_router)

from routes.atex import router as atex_router  # noqa: E402
api_router.include_router(atex_router)
...
from routes.stripe_payments import router as stripe_payments_router  # noqa: E402
...
async def _run_boot_work(boot_owner: bool):
    ...
    # Start revenue-reconciliation daily sync (Razorpay + GCP billing)
    try:
        from core.recon import start_daily_sync_task
